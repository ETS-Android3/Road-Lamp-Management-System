    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            for(Map<String,String> map:dataList)
            {
                ...
                //创建行
                TableRow tableRow = new TableRow(ManageAdminActivity.this);
                //创建列
                TextView unameView = new TextView(ManageAdminActivity.this);
                unameView.setText(uname);
                unameView.setWidth(120);
                TextView nameView = new TextView(ManageAdminActivity.this);
                nameView.setText(name);
                nameView.setWidth(120);
                Button resetPsw = new Button(ManageAdminActivity.this);
